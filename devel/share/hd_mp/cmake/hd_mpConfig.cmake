...
if("TRUE" STREQUAL "TRUE")
  set(hd_mp_SOURCE_PREFIX /home/xavier/pid/HD_Ros/src/Inverse_kinematics_robotic_arm/testarm/hd_mp)
  set(hd_mp_DEVEL_PREFIX /home/xavier/pid/HD_Ros/devel)
  set(hd_mp_INSTALL_PREFIX "")
  set(hd_mp_PREFIX ${hd_mp_DEVEL_PREFIX})
else()
  set(hd_mp_SOURCE_PREFIX "")
  set(hd_mp_DEVEL_PREFIX "")
  set(hd_mp_INSTALL_PREFIX /home/xavier/pid/HD_Ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hd_mp' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xavier/pid/HD_Ros/src/Inverse_kinematics_robotic_arm/testarm/hd_mp/${idir}'.  ${_report}")
    endif()
