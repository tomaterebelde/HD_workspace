...
(cl:defmethod cl:initialize-instance :after ((m <HandlingControl>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HandlingControl)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hd_controller_motors-msg:<HandlingControl> is deprecated: use hd_controller_motors-msg:HandlingControl instead.")))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <HandlingControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hd_controller_motors-msg:mode-val is deprecated.  Use hd_controller_motors-msg:mode instead.")
  (mode m))

(cl:ensure-generic-function 'active-val :lambda-list '(m))
(cl:defmethod active-val ((m <HandlingControl>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hd_controller_motors-msg:active-val is deprecated.  Use hd_controller_motors-msg:active instead.")
  (active m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<HandlingControl>)))
  ...
  "hd_controller_motors/HandlingControl")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'HandlingControl)))
  "Returns string type for a message object of type 'HandlingControl"
  "hd_controller_motors/HandlingControl")
